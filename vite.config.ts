...
import { filmPlanPlugin } from './tools/vite/filmPlanPlugin.ts';
...
export default defineConfig({
  // `filmPlanPlugin` : serveur de développement seulement (page `/dev/film`, absente du build).
  plugins: [react(), seoHead, filmPlanPlugin()],
